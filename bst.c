...
void main()
{
int choice; char ans='N'; int key;
node *new_node,*root,*tmp,*parent; node *get_node();
root=NULL;
clrscr();
printf("nProgram For Binary Search Tree "); do

{
printf("n1.Create");
printf("n2.Search"); printf("n3.Recursive Traversals"); printf("n4.Exit"); printf("nEnter your
...
break;
case 2:printf("nEnter Element to be searched :"); scanf("%d",&key);
